<template>
	...
	<el-col :span="2">
	  ...
	  <el-form :model="ruleForm" status-icon :rules="rules"  ref="ruleForm" :inline="false" label-width="90px" class="demo-ruleForm">
	    ...
	    <el-input type="text" placeholder="用户昵称" auto-complete="off" v-model="ruleForm.name"></el-input>
	  </el-form-item>
		...
		methods: {
          ...
          _this.message(true,data.data.msg,'error')
           ...
           name: _this.ruleForm.name,
					 pass: md5(_this.ruleForm.pass1),
					 email: _this.ruleForm.email,
					 status: _this.ruleForm.switchValue,
					 role: _this.ruleForm.role
				}
				let data = await http.post('UserApi/v1/addUser', params)
